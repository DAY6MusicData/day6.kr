function musicsite(site, theme) {
  ...
  playlist_number[51] = [147,146,148,149,132,131,147,150,151,152,55,14,147,153,154,155,139,2]; // support
  playlist_number[53] = [147,146,148,149,132]; // support 1
  playlist_number[54] = [131,147,150,151,152]; // support 2
  playlist_number[55] = [55,14,147,153]; // support 3
  playlist_number[56] = [154,155,139,2]; // support 4
